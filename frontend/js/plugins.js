...
function user_location(callback) {
// Try W3C Geolocation (Preferred)
  ...
  // Try Google Gears Geolocation
	...
	callback( new google.maps.LatLng(position.latitude,position.longitude))
    }, function() {
	callback(null);
    });
